...
"@
    ...
    Write-Host "---- start installation process"
    Start-Process -FilePath $tmpDir\$wacInstaller -ArgumentList "/qn /L*v log.txt SME_PORT=3390 SSL_CERTIFICATE_OPTION=generate RESTART_WINRM=0"  -NoNewWindow -PassThru -Wait
